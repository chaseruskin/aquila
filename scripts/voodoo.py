...
from mod import Env, Command, Generic, Blueprint, Target, TclScript
import argparse
...
class Voodoo(Target):
    ...
    def import_prelude(self, tcl: TclScript):
        ...
        """
        tcl.comment('This file is automatically @generated by Orbit.')
        tcl.comment('It is not intended for manual editing.')
        tcl.push()
